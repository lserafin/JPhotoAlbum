...
public class JPhotoFrame extends JFrame
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (cmd.equals(JPhotoMenu.A_NEW) || cmd.equals(JPhotoMenu.A_OPEN)) {
            ...
            IMessageViewer viewer = new GuiMessageViewer(this,APP_NAME,JOptionPane.ERROR_MESSAGE);
            startSlideShow(photos, list,viewer);
    ...
    public void startSlideShow(JPhotoCollection photos, JPhotoList list, IMessageViewer messageViewer) {
        if (photos.getSize()>0) {
            photoViewer(photos, list, 5000);
        }
        else
            messageViewer.showMessage("No photos to show!");

    }

    public void photoViewer(JPhotoCollection photos, JPhotoList list, int interval) {
